<template>
  <section class="py-20 px-5 md:py-28 md:px-40 bg-gray-50">
    ...
    <div class="md:flex flex-wrap justify-center gap-5 mt-10">
      ...
      >
        <img
          src="~/assets/imgs/ambulance-cross.svg"
        ...
        <div class="">
          ...
          <p class="">
            FREE prescription delivery within the GTA. Simply call us to get
            started.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div class="">
          ...
          <p class="">
            Our goal is to provide you the best health care at the best prices.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div class="">
          ...
          <p class="">
            FREE easy-to-use packaging to take your medications in the right
            dose and time.
          </p>
        </div>
      </div>
