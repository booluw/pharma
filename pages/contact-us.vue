<template>
  <div class="">
    <section
      class="py-40 px-5 md:h-screen md:flex gap-10 md:pl-40 md:pr-0 md:py-20 items-center bg-green-300"
    >
      <div class="md:w-1/2">
        <h1
          class="font-bold text-3xl md:text-5xl relative z-10 font-serif"
          data-gsap="staggered-text"
        >
          Contact Us!
        </h1>
        <p class="text-xl opacity-75 mt-5">
          Our Full-service pharmacy is here to serve your needs. We invite you
    ...
    <section class="py-20 px-5 min-h-screen md:flex gap-10 md:pl-40 md:py-20">
      <div class="md:w-1/2">
        ...
        <h2 class="mt-16 text-2xl font-serif font-semibold header">
          Hours of operation
        </h2>
        <div class="mt-3 md:w-2/3">
          ...
          >
            Monday
            <p class="text-gray-500">10:00 AM - 6:00PM</p>
          </div>
          <div
            class="time flex justify-between items-center border-b p-3"
          ...
          >
            Saturday
            <p class="text-gray-500">10:00 AM - 2:00PM</p>
          </div>
        </div>
      </div>
      <iframe
    ...
    <section
      class="py-20 px-5 min-h-screen md:flex gap-16 md:pl-0 md:pr-40 md:py-20"
    >
      ...
      <div class="md:w-1/2">
        <h1
          class="header font-bold text-3xl md:text-5xl relative z-10 font-serif"
        >
          Get in touch!
        </h1>
        <p class="">
          We love to hear from you. Send us your feedback or questions and we
          will get back to you as soon as possible
        </p>
        <form
          ref="form"
          class="slideUp border rounded-lg p-5 md:p-10 mt-9"
