<template>
  <div>
    ...
    <div
      v-if="true"
      class="fixed bottom-5 md:bottom-24 right-0 p-5 w-auto flex gap-4"
    >
      <a
        href="tel:+1725-205-3641"
        class="bg-secondary p-3 rounded-full shadow-md text-white hidden md:block"
      >
        <svg
      ...
      <p
        class="bg-primary text-white md:bg-white md:text-black py-3 px-5 rounded-3xl shadow-md text-sm"
      >
        Hello, we are open.
      </p>
    </div>
